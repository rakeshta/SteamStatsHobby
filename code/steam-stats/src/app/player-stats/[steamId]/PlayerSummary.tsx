...
export function PlayerSummary({ className, stats }: Props) {
  return (
    <Card className={clsx('p-4 flex flex-col items-center md:flex-row md:items-stretch', className)}>
      <img className='rounded-md rotate-3 w-60 self-center' src={stats.avatarUrl} alt='Player Avatar' />
